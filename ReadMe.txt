...
display_vivado是用来测试摄像头显示器回路是否工作正常的vivado工程
display_vitis是用来测试摄像头显示器回路是否工作正常的vitis工程

sd文件夹是装载进sd卡的文件。使用Genesys ZU3eg开发板，把sd卡格式化成FAT32后，选择SD卡启动，即可运行Demo工程。


--------------------------------------------------------------------------------------------


工程描述：该工程实现了一个通用的卷积神经网络加速器，成功搭载Yolov3tiny。配合摄像头采集+显示器回显环路，构建了一个高性能实时目标识别与检测系统。
...
所需背景知识：需要熟练掌握Verilog，熟悉Zynq架构，熟悉AXI总线，了解卷积神经网络

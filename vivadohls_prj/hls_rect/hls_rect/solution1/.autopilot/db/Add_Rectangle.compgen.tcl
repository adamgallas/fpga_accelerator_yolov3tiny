...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_xleft \
    op interface \
    ports { xleft_dout { I 16 vector } xleft_empty_n { I 1 bit } xleft_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_xright \
    op interface \
    ports { xright_dout { I 16 vector } xright_empty_n { I 1 bit } xright_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ytop \
    op interface \
    ports { ytop_dout { I 16 vector } ytop_empty_n { I 1 bit } ytop_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ydown \
    op interface \
    ports { ydown_dout { I 16 vector } ydown_empty_n { I 1 bit } ydown_read { O 1 bit } } \
} "
}

...
set C_modelArgList {
	...
	{ ch5x_loc int 16 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "src_data_stream_0_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ch5x_loc", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ch5x_loc_dout sc_in sc_lv 16 signal 8 } 
	{ ch5x_loc_empty_n sc_in sc_logic 1 signal 8 } 
	{ ch5x_loc_read sc_out sc_logic 1 signal 8 } 
	{ ytop_s_dout sc_in sc_lv 16 signal 9 } 
	{ ytop_s_empty_n sc_in sc_logic 1 signal 9 } 
	{ ytop_s_read sc_out sc_logic 1 signal 9 } 
	{ char5_dout sc_in sc_lv 8 signal 10 } 
	{ char5_empty_n sc_in sc_logic 1 signal 10 } 
	{ char5_read sc_out sc_logic 1 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ch5x_loc_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "ch5x_loc", "role": "dout" }} , 
 	{ "name": "ch5x_loc_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ch5x_loc", "role": "empty_n" }} , 
 	{ "name": "ch5x_loc_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ch5x_loc", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "ch5x_loc", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.letter297_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	ch5x_loc { ap_fifo {  { ch5x_loc_dout fifo_data 0 16 }  { ch5x_loc_empty_n fifo_status 0 1 }  { ch5x_loc_read fifo_update 1 1 } } }

...
#ifndef _hls_rect_entry304_HH_
#define _hls_rect_entry304_HH_
...
struct hls_rect_entry304 : public sc_module {
    ...
    sc_in< sc_lv<16> > xright_s_dout;
    sc_in< sc_logic > xright_s_empty_n;
    sc_out< sc_logic > xright_s_read;
    sc_in< sc_lv<16> > ytop_s_dout;
    sc_in< sc_logic > ytop_s_empty_n;
    sc_out< sc_logic > ytop_s_read;
    sc_in< sc_lv<16> > ydown_s_dout;
    sc_in< sc_logic > ydown_s_empty_n;
    sc_out< sc_logic > ydown_s_read;
    ...
    sc_in< sc_lv<8> > char1_dout;
    sc_in< sc_logic > char1_empty_n;
    sc_out< sc_logic > char1_read;
    ...
    sc_out< sc_lv<16> > xleft_out1_din;
    ...
    // Module declarations
    hls_rect_entry304(sc_module_name name);
    SC_HAS_PROCESS(hls_rect_entry304);
    ...
    void thread_xright_s_blk_n();
    void thread_xright_s_read();
    void thread_ydown_out_blk_n();
    void thread_ydown_out_din();
    void thread_ydown_out_write();
    void thread_ydown_s_blk_n();
    void thread_ydown_s_read();

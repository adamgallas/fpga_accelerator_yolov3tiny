...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 xleft_s W 0x0 "Data signal of xleft_s" {{0 16 xleft_s W 0 "Bit 15 to 0 Data signal of xleft_s"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 xright_s W 0x0 "Data signal of xright_s" {{0 16 xright_s W 0 "Bit 15 to 0 Data signal of xright_s"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 ytop_s W 0x0 "Data signal of ytop_s" {{0 16 ytop_s W 0 "Bit 15 to 0 Data signal of ytop_s"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 ydown_s W 0x0 "Data signal of ydown_s" {{0 16 ydown_s W 0 "Bit 15 to 0 Data signal of ydown_s"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 color1 W 0x0 "Data signal of color1" {{0 8 color1 W 0 "Bit 7 to 0 Data signal of color1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 color2 W 0x0 "Data signal of color2" {{0 8 color2 W 0 "Bit 7 to 0 Data signal of color2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 color3 W 0x0 "Data signal of color3" {{0 8 color3 W 0 "Bit 7 to 0 Data signal of color3"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 char1 W 0x0 "Data signal of char1" {{0 8 char1 W 0 "Bit 7 to 0 Data signal of char1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 char2 W 0x0 "Data signal of char2" {{0 8 char2 W 0 "Bit 7 to 0 Data signal of char2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 char3 W 0x0 "Data signal of char3" {{0 8 char3 W 0 "Bit 7 to 0 Data signal of char3"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 char4 W 0x0 "Data signal of char4" {{0 8 char4 W 0 "Bit 7 to 0 Data signal of char4"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 char5 W 0x0 "Data signal of char5" {{0 8 char5 W 0 "Bit 7 to 0 Data signal of char5"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 char6 W 0x0 "Data signal of char6" {{0 8 char6 W 0 "Bit 7 to 0 Data signal of char6"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 925215 II x}

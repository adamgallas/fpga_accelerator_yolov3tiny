...
const int hls_preprocess::C_S_AXI_DATA_WIDTH = "100000";
const int hls_preprocess::C_S_AXI_WSTRB_WIDTH = "100";
const int hls_preprocess::C_S_AXI_ADDR_WIDTH = "100000";
const sc_logic hls_preprocess::ap_const_logic_1 = sc_dt::Log_1;
const sc_lv<32> hls_preprocess::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<4> hls_preprocess::ap_const_lv4_0 = "0000";
const sc_lv<1> hls_preprocess::ap_const_lv1_0 = "0";
const sc_logic hls_preprocess::ap_const_logic_0 = sc_dt::Log_0;

hls_preprocess::hls_preprocess(sc_module_name name) : sc_module(name), mVcdFile(0) {
    hls_preprocess_AXILiteS_s_axi_U = new hls_preprocess_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>("hls_preprocess_AXILiteS_s_axi_U");
    hls_preprocess_AXILiteS_s_axi_U->AWVALID(s_axi_AXILiteS_AWVALID);
    hls_preprocess_AXILiteS_s_axi_U->AWREADY(s_axi_AXILiteS_AWREADY);
    hls_preprocess_AXILiteS_s_axi_U->AWADDR(s_axi_AXILiteS_AWADDR);
    hls_preprocess_AXILiteS_s_axi_U->WVALID(s_axi_AXILiteS_WVALID);
    hls_preprocess_AXILiteS_s_axi_U->WREADY(s_axi_AXILiteS_WREADY);
    hls_preprocess_AXILiteS_s_axi_U->WDATA(s_axi_AXILiteS_WDATA);
    hls_preprocess_AXILiteS_s_axi_U->WSTRB(s_axi_AXILiteS_WSTRB);
    hls_preprocess_AXILiteS_s_axi_U->ARVALID(s_axi_AXILiteS_ARVALID);
    hls_preprocess_AXILiteS_s_axi_U->ARREADY(s_axi_AXILiteS_ARREADY);
    hls_preprocess_AXILiteS_s_axi_U->ARADDR(s_axi_AXILiteS_ARADDR);
    hls_preprocess_AXILiteS_s_axi_U->RVALID(s_axi_AXILiteS_RVALID);
    hls_preprocess_AXILiteS_s_axi_U->RREADY(s_axi_AXILiteS_RREADY);
    hls_preprocess_AXILiteS_s_axi_U->RDATA(s_axi_AXILiteS_RDATA);
    hls_preprocess_AXILiteS_s_axi_U->RRESP(s_axi_AXILiteS_RRESP);
    hls_preprocess_AXILiteS_s_axi_U->BVALID(s_axi_AXILiteS_BVALID);
    hls_preprocess_AXILiteS_s_axi_U->BREADY(s_axi_AXILiteS_BREADY);
    hls_preprocess_AXILiteS_s_axi_U->BRESP(s_axi_AXILiteS_BRESP);
    hls_preprocess_AXILiteS_s_axi_U->ACLK(ap_clk);
    hls_preprocess_AXILiteS_s_axi_U->ARESET(ap_rst_n_inv);
    hls_preprocess_AXILiteS_s_axi_U->ACLK_EN(ap_var_for_const0);
    hls_preprocess_AXILiteS_s_axi_U->ap_start(ap_start);
    hls_preprocess_AXILiteS_s_axi_U->interrupt(interrupt);
    hls_preprocess_AXILiteS_s_axi_U->ap_ready(ap_ready);
    hls_preprocess_AXILiteS_s_axi_U->ap_done(ap_done);
    hls_preprocess_AXILiteS_s_axi_U->ap_idle(ap_idle);
    ...
    Downsample_U0->start_full_n(start_for_Convert_U0_full_n);
    ...
    Convert_U0 = new Convert("Convert_U0");
    Convert_U0->ap_clk(ap_clk);
    Convert_U0->ap_rst(ap_rst_n_inv);
    Convert_U0->ap_start(Convert_U0_ap_start);
    Convert_U0->start_full_n(start_for_Mat2AXIvideo_U0_full_n);
    Convert_U0->ap_done(Convert_U0_ap_done);
    Convert_U0->ap_continue(Convert_U0_ap_continue);
    Convert_U0->ap_idle(Convert_U0_ap_idle);
    Convert_U0->ap_ready(Convert_U0_ap_ready);
    Convert_U0->start_out(Convert_U0_start_out);
    Convert_U0->start_write(Convert_U0_start_write);
    Convert_U0->src_data_stream_0_V_dout(dst_img_data_stream_s_dout);
    Convert_U0->src_data_stream_0_V_empty_n(dst_img_data_stream_s_empty_n);
    Convert_U0->src_data_stream_0_V_read(Convert_U0_src_data_stream_0_V_read);
    Convert_U0->src_data_stream_1_V_dout(dst_img_data_stream_1_dout);
    Convert_U0->src_data_stream_1_V_empty_n(dst_img_data_stream_1_empty_n);
    Convert_U0->src_data_stream_1_V_read(Convert_U0_src_data_stream_1_V_read);
    Convert_U0->src_data_stream_2_V_dout(dst_img_data_stream_2_dout);
    Convert_U0->src_data_stream_2_V_empty_n(dst_img_data_stream_2_empty_n);
    Convert_U0->src_data_stream_2_V_read(Convert_U0_src_data_stream_2_V_read);
    Convert_U0->src_data_stream_3_V_dout(dst_img_data_stream_3_dout);
    Convert_U0->src_data_stream_3_V_empty_n(dst_img_data_stream_3_empty_n);
    Convert_U0->src_data_stream_3_V_read(Convert_U0_src_data_stream_3_V_read);
    Convert_U0->dst_data_stream_0_V_din(Convert_U0_dst_data_stream_0_V_din);
    Convert_U0->dst_data_stream_0_V_full_n(ifm_img_data_stream_s_full_n);
    Convert_U0->dst_data_stream_0_V_write(Convert_U0_dst_data_stream_0_V_write);
    Convert_U0->dst_data_stream_1_V_din(Convert_U0_dst_data_stream_1_V_din);
    Convert_U0->dst_data_stream_1_V_full_n(ifm_img_data_stream_1_full_n);
    Convert_U0->dst_data_stream_1_V_write(Convert_U0_dst_data_stream_1_V_write);
    Convert_U0->dst_data_stream_2_V_din(Convert_U0_dst_data_stream_2_V_din);
    Convert_U0->dst_data_stream_2_V_full_n(ifm_img_data_stream_2_full_n);
    Convert_U0->dst_data_stream_2_V_write(Convert_U0_dst_data_stream_2_V_write);
    Convert_U0->dst_data_stream_3_V_din(Convert_U0_dst_data_stream_3_V_din);
    Convert_U0->dst_data_stream_3_V_full_n(ifm_img_data_stream_3_full_n);
    Convert_U0->dst_data_stream_3_V_write(Convert_U0_dst_data_stream_3_V_write);
    ...
    Mat2AXIvideo_U0->img_data_stream_0_V_dout(ifm_img_data_stream_s_dout);
    Mat2AXIvideo_U0->img_data_stream_0_V_empty_n(ifm_img_data_stream_s_empty_n);
    Mat2AXIvideo_U0->img_data_stream_0_V_read(Mat2AXIvideo_U0_img_data_stream_0_V_read);
    Mat2AXIvideo_U0->img_data_stream_1_V_dout(ifm_img_data_stream_1_dout);
    Mat2AXIvideo_U0->img_data_stream_1_V_empty_n(ifm_img_data_stream_1_empty_n);
    Mat2AXIvideo_U0->img_data_stream_1_V_read(Mat2AXIvideo_U0_img_data_stream_1_V_read);
    Mat2AXIvideo_U0->img_data_stream_2_V_dout(ifm_img_data_stream_2_dout);
    Mat2AXIvideo_U0->img_data_stream_2_V_empty_n(ifm_img_data_stream_2_empty_n);
    Mat2AXIvideo_U0->img_data_stream_2_V_read(Mat2AXIvideo_U0_img_data_stream_2_V_read);
    Mat2AXIvideo_U0->img_data_stream_3_V_dout(ifm_img_data_stream_3_dout);
    Mat2AXIvideo_U0->img_data_stream_3_V_empty_n(ifm_img_data_stream_3_empty_n);
    ...
    dst_img_data_stream_s_U->if_read(Convert_U0_src_data_stream_0_V_read);
    ...
    dst_img_data_stream_1_U->if_read(Convert_U0_src_data_stream_1_V_read);
    ...
    dst_img_data_stream_2_U->if_read(Convert_U0_src_data_stream_2_V_read);
    ...
    dst_img_data_stream_3_U->if_read(Convert_U0_src_data_stream_3_V_read);
    ifm_img_data_stream_s_U = new fifo_w8_d2_A("ifm_img_data_stream_s_U");
    ifm_img_data_stream_s_U->clk(ap_clk);
    ifm_img_data_stream_s_U->reset(ap_rst_n_inv);
    ifm_img_data_stream_s_U->if_read_ce(ap_var_for_const0);
    ifm_img_data_stream_s_U->if_write_ce(ap_var_for_const0);
    ifm_img_data_stream_s_U->if_din(Convert_U0_dst_data_stream_0_V_din);
    ifm_img_data_stream_s_U->if_full_n(ifm_img_data_stream_s_full_n);
    ifm_img_data_stream_s_U->if_write(Convert_U0_dst_data_stream_0_V_write);
    ifm_img_data_stream_s_U->if_dout(ifm_img_data_stream_s_dout);
    ifm_img_data_stream_s_U->if_empty_n(ifm_img_data_stream_s_empty_n);
    ifm_img_data_stream_s_U->if_read(Mat2AXIvideo_U0_img_data_stream_0_V_read);
    ifm_img_data_stream_1_U = new fifo_w8_d2_A("ifm_img_data_stream_1_U");
    ifm_img_data_stream_1_U->clk(ap_clk);
    ifm_img_data_stream_1_U->reset(ap_rst_n_inv);
    ifm_img_data_stream_1_U->if_read_ce(ap_var_for_const0);
    ifm_img_data_stream_1_U->if_write_ce(ap_var_for_const0);
    ifm_img_data_stream_1_U->if_din(Convert_U0_dst_data_stream_1_V_din);
    ifm_img_data_stream_1_U->if_full_n(ifm_img_data_stream_1_full_n);
    ifm_img_data_stream_1_U->if_write(Convert_U0_dst_data_stream_1_V_write);
    ifm_img_data_stream_1_U->if_dout(ifm_img_data_stream_1_dout);
    ifm_img_data_stream_1_U->if_empty_n(ifm_img_data_stream_1_empty_n);
    ifm_img_data_stream_1_U->if_read(Mat2AXIvideo_U0_img_data_stream_1_V_read);
    ifm_img_data_stream_2_U = new fifo_w8_d2_A("ifm_img_data_stream_2_U");
    ifm_img_data_stream_2_U->clk(ap_clk);
    ifm_img_data_stream_2_U->reset(ap_rst_n_inv);
    ifm_img_data_stream_2_U->if_read_ce(ap_var_for_const0);
    ifm_img_data_stream_2_U->if_write_ce(ap_var_for_const0);
    ifm_img_data_stream_2_U->if_din(Convert_U0_dst_data_stream_2_V_din);
    ifm_img_data_stream_2_U->if_full_n(ifm_img_data_stream_2_full_n);
    ifm_img_data_stream_2_U->if_write(Convert_U0_dst_data_stream_2_V_write);
    ifm_img_data_stream_2_U->if_dout(ifm_img_data_stream_2_dout);
    ifm_img_data_stream_2_U->if_empty_n(ifm_img_data_stream_2_empty_n);
    ifm_img_data_stream_2_U->if_read(Mat2AXIvideo_U0_img_data_stream_2_V_read);
    ifm_img_data_stream_3_U = new fifo_w8_d2_A("ifm_img_data_stream_3_U");
    ifm_img_data_stream_3_U->clk(ap_clk);
    ifm_img_data_stream_3_U->reset(ap_rst_n_inv);
    ifm_img_data_stream_3_U->if_read_ce(ap_var_for_const0);
    ifm_img_data_stream_3_U->if_write_ce(ap_var_for_const0);
    ifm_img_data_stream_3_U->if_din(Convert_U0_dst_data_stream_3_V_din);
    ifm_img_data_stream_3_U->if_full_n(ifm_img_data_stream_3_full_n);
    ifm_img_data_stream_3_U->if_write(Convert_U0_dst_data_stream_3_V_write);
    ifm_img_data_stream_3_U->if_dout(ifm_img_data_stream_3_dout);
    ifm_img_data_stream_3_U->if_empty_n(ifm_img_data_stream_3_empty_n);
    ifm_img_data_stream_3_U->if_read(Mat2AXIvideo_U0_img_data_stream_3_V_read);
    ...
    start_for_Convertcud_U = new start_for_Convertcud("start_for_Convertcud_U");
    start_for_Convertcud_U->clk(ap_clk);
    start_for_Convertcud_U->reset(ap_rst_n_inv);
    start_for_Convertcud_U->if_read_ce(ap_var_for_const0);
    start_for_Convertcud_U->if_write_ce(ap_var_for_const0);
    start_for_Convertcud_U->if_din(start_for_Convert_U0_din);
    start_for_Convertcud_U->if_full_n(start_for_Convert_U0_full_n);
    start_for_Convertcud_U->if_write(Downsample_U0_start_write);
    start_for_Convertcud_U->if_dout(start_for_Convert_U0_dout);
    start_for_Convertcud_U->if_empty_n(start_for_Convert_U0_empty_n);
    start_for_Convertcud_U->if_read(Convert_U0_ap_ready);
    ...
    start_for_Mat2AXIdEe_U->if_write(Convert_U0_start_write);
    ...
    SC_METHOD(thread_Convert_U0_ap_continue);

    SC_METHOD(thread_Convert_U0_ap_start);
    sensitive << ( start_for_Convert_U0_empty_n );
    ...
    SC_METHOD(thread_start_for_Convert_U0_din);
    ...
    apTFilenSS << "hls_preprocess_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, Convert_U0_ap_start, "Convert_U0_ap_start");
    sc_trace(mVcdFile, Convert_U0_ap_done, "Convert_U0_ap_done");
    sc_trace(mVcdFile, Convert_U0_ap_continue, "Convert_U0_ap_continue");
    sc_trace(mVcdFile, Convert_U0_ap_idle, "Convert_U0_ap_idle");
    sc_trace(mVcdFile, Convert_U0_ap_ready, "Convert_U0_ap_ready");
    sc_trace(mVcdFile, Convert_U0_start_out, "Convert_U0_start_out");
    sc_trace(mVcdFile, Convert_U0_start_write, "Convert_U0_start_write");
    sc_trace(mVcdFile, Convert_U0_src_data_stream_0_V_read, "Convert_U0_src_data_stream_0_V_read");
    sc_trace(mVcdFile, Convert_U0_src_data_stream_1_V_read, "Convert_U0_src_data_stream_1_V_read");
    sc_trace(mVcdFile, Convert_U0_src_data_stream_2_V_read, "Convert_U0_src_data_stream_2_V_read");
    sc_trace(mVcdFile, Convert_U0_src_data_stream_3_V_read, "Convert_U0_src_data_stream_3_V_read");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_0_V_din, "Convert_U0_dst_data_stream_0_V_din");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_0_V_write, "Convert_U0_dst_data_stream_0_V_write");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_1_V_din, "Convert_U0_dst_data_stream_1_V_din");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_1_V_write, "Convert_U0_dst_data_stream_1_V_write");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_2_V_din, "Convert_U0_dst_data_stream_2_V_din");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_2_V_write, "Convert_U0_dst_data_stream_2_V_write");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_3_V_din, "Convert_U0_dst_data_stream_3_V_din");
    sc_trace(mVcdFile, Convert_U0_dst_data_stream_3_V_write, "Convert_U0_dst_data_stream_3_V_write");
    ...
    sc_trace(mVcdFile, ifm_img_data_stream_s_full_n, "ifm_img_data_stream_s_full_n");
    sc_trace(mVcdFile, ifm_img_data_stream_s_dout, "ifm_img_data_stream_s_dout");
    sc_trace(mVcdFile, ifm_img_data_stream_s_empty_n, "ifm_img_data_stream_s_empty_n");
    sc_trace(mVcdFile, ifm_img_data_stream_1_full_n, "ifm_img_data_stream_1_full_n");
    sc_trace(mVcdFile, ifm_img_data_stream_1_dout, "ifm_img_data_stream_1_dout");
    sc_trace(mVcdFile, ifm_img_data_stream_1_empty_n, "ifm_img_data_stream_1_empty_n");
    sc_trace(mVcdFile, ifm_img_data_stream_2_full_n, "ifm_img_data_stream_2_full_n");
    sc_trace(mVcdFile, ifm_img_data_stream_2_dout, "ifm_img_data_stream_2_dout");
    sc_trace(mVcdFile, ifm_img_data_stream_2_empty_n, "ifm_img_data_stream_2_empty_n");
    sc_trace(mVcdFile, ifm_img_data_stream_3_full_n, "ifm_img_data_stream_3_full_n");
    sc_trace(mVcdFile, ifm_img_data_stream_3_dout, "ifm_img_data_stream_3_dout");
    sc_trace(mVcdFile, ifm_img_data_stream_3_empty_n, "ifm_img_data_stream_3_empty_n");
    ...
    sc_trace(mVcdFile, start_for_Convert_U0_din, "start_for_Convert_U0_din");
    sc_trace(mVcdFile, start_for_Convert_U0_full_n, "start_for_Convert_U0_full_n");
    sc_trace(mVcdFile, start_for_Convert_U0_dout, "start_for_Convert_U0_dout");
    sc_trace(mVcdFile, start_for_Convert_U0_empty_n, "start_for_Convert_U0_empty_n");
    ...
    mHdltvinHandle.open("hls_preprocess.hdltvin.dat");
    mHdltvoutHandle.open("hls_preprocess.hdltvout.dat");
}

hls_preprocess::~hls_preprocess() {
    if (mVcdFile) 
    ...
    delete hls_preprocess_AXILiteS_s_axi_U;
    ...
    delete ifm_img_data_stream_s_U;
    delete ifm_img_data_stream_1_U;
    delete ifm_img_data_stream_2_U;
    delete ifm_img_data_stream_3_U;
    delete start_for_Downsambkb_U;
    delete start_for_Convertcud_U;
    delete start_for_Mat2AXIdEe_U;
}

void hls_preprocess::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void hls_preprocess::thread_AXIvideo2Mat_U0_ap_continue() {
    AXIvideo2Mat_U0_ap_continue = ap_const_logic_1;
}

void hls_preprocess::thread_AXIvideo2Mat_U0_ap_start() {
    AXIvideo2Mat_U0_ap_start = ap_start.read();
}

void hls_preprocess::thread_Convert_U0_ap_continue() {
    Convert_U0_ap_continue = ap_const_logic_1;
}

void hls_preprocess::thread_Convert_U0_ap_start() {
    Convert_U0_ap_start = start_for_Convert_U0_empty_n.read();
}

void hls_preprocess::thread_Downsample_U0_ap_continue() {
    Downsample_U0_ap_continue = ap_const_logic_1;
}

void hls_preprocess::thread_Downsample_U0_ap_start() {
    Downsample_U0_ap_start = start_for_Downsample_U0_empty_n.read();
}

void hls_preprocess::thread_Mat2AXIvideo_U0_ap_continue() {
    Mat2AXIvideo_U0_ap_continue = ap_const_logic_1;
}

void hls_preprocess::thread_Mat2AXIvideo_U0_ap_start() {
    Mat2AXIvideo_U0_ap_start = start_for_Mat2AXIvideo_U0_empty_n.read();
}

void hls_preprocess::thread_Mat2AXIvideo_U0_start_full_n() {
    Mat2AXIvideo_U0_start_full_n = ap_const_logic_1;
}

void hls_preprocess::thread_Mat2AXIvideo_U0_start_write() {
    Mat2AXIvideo_U0_start_write = ap_const_logic_0;
}

void hls_preprocess::thread_ap_done() {
    ap_done = Mat2AXIvideo_U0_ap_done.read();
}

void hls_preprocess::thread_ap_idle() {
    ap_idle = (AXIvideo2Mat_U0_ap_idle.read() & Downsample_U0_ap_idle.read() & Convert_U0_ap_idle.read() & Mat2AXIvideo_U0_ap_idle.read());
}

void hls_preprocess::thread_ap_ready() {
    ap_ready = AXIvideo2Mat_U0_ap_ready.read();
}

void hls_preprocess::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void hls_preprocess::thread_ap_sync_continue() {
    ap_sync_continue = ap_const_logic_1;
}

void hls_preprocess::thread_ap_sync_done() {
    ap_sync_done = Mat2AXIvideo_U0_ap_done.read();
}

void hls_preprocess::thread_ap_sync_ready() {
    ap_sync_ready = AXIvideo2Mat_U0_ap_ready.read();
}

void hls_preprocess::thread_start_for_Convert_U0_din() {
    start_for_Convert_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void hls_preprocess::thread_start_for_Downsample_U0_din() {
    start_for_Downsample_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void hls_preprocess::thread_start_for_Mat2AXIvideo_U0_din() {
    start_for_Mat2AXIvideo_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void hls_preprocess::thread_video_dst_TDATA() {
    video_dst_TDATA = Mat2AXIvideo_U0_video_dst_TDATA.read();
}

void hls_preprocess::thread_video_dst_TDEST() {
    video_dst_TDEST = Mat2AXIvideo_U0_video_dst_TDEST.read();
}

void hls_preprocess::thread_video_dst_TID() {
    video_dst_TID = Mat2AXIvideo_U0_video_dst_TID.read();
}

void hls_preprocess::thread_video_dst_TKEEP() {
    video_dst_TKEEP = Mat2AXIvideo_U0_video_dst_TKEEP.read();
}

void hls_preprocess::thread_video_dst_TLAST() {
    video_dst_TLAST = Mat2AXIvideo_U0_video_dst_TLAST.read();
}

void hls_preprocess::thread_video_dst_TSTRB() {
    video_dst_TSTRB = Mat2AXIvideo_U0_video_dst_TSTRB.read();
}

void hls_preprocess::thread_video_dst_TUSER() {
    video_dst_TUSER = Mat2AXIvideo_U0_video_dst_TUSER.read();
}

void hls_preprocess::thread_video_dst_TVALID() {
    video_dst_TVALID = Mat2AXIvideo_U0_video_dst_TVALID.read();
}

void hls_preprocess::thread_video_src_TREADY() {
    video_src_TREADY = AXIvideo2Mat_U0_video_src_TREADY.read();
}

void hls_preprocess::thread_hdltv_gen() {

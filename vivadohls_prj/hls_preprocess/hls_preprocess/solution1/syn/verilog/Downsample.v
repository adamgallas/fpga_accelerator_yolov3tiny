...
reg   [0:0] and_ln50_2_reg_358;
reg   [0:0] and_ln51_reg_362;
reg    dst_data_stream_1_V_blk_n;
reg    dst_data_stream_2_V_blk_n;
reg    dst_data_stream_3_V_blk_n;
reg   [10:0] j_0_reg_241;
wire   [0:0] trunc_ln44_fu_252_p1;
reg   [0:0] trunc_ln44_reg_330;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln44_fu_256_p2;
wire   [9:0] i_fu_262_p2;
reg   [9:0] i_reg_339;
wire   [0:0] and_ln50_1_fu_280_p2;
reg   [0:0] and_ln50_1_reg_344;
...
wire   [0:0] and_ln50_2_fu_320_p2;
wire   [0:0] and_ln51_fu_325_p2;
...
wire   [0:0] icmp_ln50_1_fu_274_p2;
wire   [0:0] icmp_ln50_2_fu_302_p2;
wire   [0:0] icmp_ln50_3_fu_308_p2;
wire   [0:0] and_ln50_fu_314_p2;
wire   [0:0] trunc_ln46_fu_286_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln44_fu_256_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln44_fu_256_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln46_fu_290_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln44_fu_256_p2 == 1'd0))) begin
        and_ln50_1_reg_344 <= and_ln50_1_fu_280_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln46_fu_290_p2 == 1'd0))) begin
        and_ln50_2_reg_358 <= and_ln50_2_fu_320_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'd1 == and_ln50_2_fu_320_p2) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln46_fu_290_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((icmp_ln46_fu_290_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln44_fu_256_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'd1 == and_ln51_reg_362) & (1'd1 == and_ln50_2_reg_358) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((icmp_ln46_fu_290_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((icmp_ln46_fu_290_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign and_ln50_1_fu_280_p2 = (icmp_ln50_fu_268_p2 & icmp_ln50_1_fu_274_p2);

assign and_ln50_2_fu_320_p2 = (and_ln50_fu_314_p2 & and_ln50_1_reg_344);

assign and_ln50_fu_314_p2 = (icmp_ln50_3_fu_308_p2 & icmp_ln50_2_fu_302_p2);

assign and_ln51_fu_325_p2 = (trunc_ln46_fu_286_p1 & trunc_ln44_reg_330);
...
always @ (*) begin
    ap_predicate_op53_write_state4 = ((1'd1 == and_ln51_reg_362) & (1'd1 == and_ln50_2_reg_358));
end

always @ (*) begin
    ap_predicate_op54_write_state4 = ((1'd1 == and_ln51_reg_362) & (1'd1 == and_ln50_2_reg_358));
end

always @ (*) begin
    ap_predicate_op55_write_state4 = ((1'd1 == and_ln51_reg_362) & (1'd1 == and_ln50_2_reg_358));
end

always @ (*) begin
    ap_predicate_op56_write_state4 = ((1'd1 == and_ln51_reg_362) & (1'd1 == and_ln50_2_reg_358));
end
...
assign icmp_ln44_fu_256_p2 = ((i_0_reg_230 == 10'd720) ? 1'b1 : 1'b0);

assign icmp_ln46_fu_290_p2 = ((j_0_reg_241 == 11'd1280) ? 1'b1 : 1'b0);

assign icmp_ln50_1_fu_274_p2 = ((i_0_reg_230 < 10'd618) ? 1'b1 : 1'b0);

assign icmp_ln50_2_fu_302_p2 = ((j_0_reg_241 > 11'd221) ? 1'b1 : 1'b0);

assign icmp_ln50_3_fu_308_p2 = ((j_0_reg_241 < 11'd1058) ? 1'b1 : 1'b0);

assign icmp_ln50_fu_268_p2 = ((i_0_reg_230 > 10'd101) ? 1'b1 : 1'b0);

assign j_fu_296_p2 = (11'd1 + j_0_reg_241);

assign start_out = real_start;

assign trunc_ln44_fu_252_p1 = i_0_reg_230[0:0];

assign trunc_ln46_fu_286_p1 = j_0_reg_241[0:0];

...
architecture behav of Downsample is 
    ...
    signal and_ln50_2_reg_358 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln51_reg_362 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln44_fu_252_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln44_reg_330 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln44_fu_256_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_262_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_reg_339 : STD_LOGIC_VECTOR (9 downto 0);
    signal and_ln50_1_fu_280_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln50_1_reg_344 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal and_ln50_2_fu_320_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln51_fu_325_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln50_1_fu_274_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln50_2_fu_302_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln50_3_fu_308_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln50_fu_314_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln46_fu_286_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln44_fu_256_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln44_fu_256_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln46_fu_290_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln44_fu_256_p2 = ap_const_lv1_0))) then
                and_ln50_1_reg_344 <= and_ln50_1_fu_280_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln46_fu_290_p2 = ap_const_lv1_0))) then
                and_ln50_2_reg_358 <= and_ln50_2_fu_320_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = and_ln50_2_fu_320_p2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln46_fu_290_p2 = ap_const_lv1_0))) then
                and_ln51_reg_362 <= and_ln51_fu_325_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ...
                trunc_ln44_reg_330 <= trunc_ln44_fu_252_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln44_fu_256_p2, icmp_ln46_fu_290_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln44_fu_256_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((icmp_ln46_fu_290_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((icmp_ln46_fu_290_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then
    ...
    and_ln50_1_fu_280_p2 <= (icmp_ln50_fu_268_p2 and icmp_ln50_1_fu_274_p2);
    and_ln50_2_fu_320_p2 <= (and_ln50_fu_314_p2 and and_ln50_1_reg_344);
    and_ln50_fu_314_p2 <= (icmp_ln50_3_fu_308_p2 and icmp_ln50_2_fu_302_p2);
    and_ln51_fu_325_p2 <= (trunc_ln46_fu_286_p1 and trunc_ln44_reg_330);
    ...
    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln46_fu_290_p2)
    begin
        if ((icmp_ln46_fu_290_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln44_fu_256_p2)
    begin
        if (((icmp_ln44_fu_256_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_predicate_op53_write_state4_assign_proc : process(and_ln50_2_reg_358, and_ln51_reg_362)
    begin
                ap_predicate_op53_write_state4 <= ((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358));
    end process;


    ap_predicate_op54_write_state4_assign_proc : process(and_ln50_2_reg_358, and_ln51_reg_362)
    begin
                ap_predicate_op54_write_state4 <= ((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358));
    end process;


    ap_predicate_op55_write_state4_assign_proc : process(and_ln50_2_reg_358, and_ln51_reg_362)
    begin
                ap_predicate_op55_write_state4 <= ((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358));
    end process;


    ap_predicate_op56_write_state4_assign_proc : process(and_ln50_2_reg_358, and_ln51_reg_362)
    begin
                ap_predicate_op56_write_state4 <= ((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358));
    end process;

    ap_ready <= internal_ap_ready;

    dst_data_stream_0_V_blk_n_assign_proc : process(dst_data_stream_0_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, and_ln50_2_reg_358, and_ln51_reg_362)
    begin
        if (((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    dst_data_stream_1_V_blk_n_assign_proc : process(dst_data_stream_1_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, and_ln50_2_reg_358, and_ln51_reg_362)
    begin
        if (((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    dst_data_stream_2_V_blk_n_assign_proc : process(dst_data_stream_2_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, and_ln50_2_reg_358, and_ln51_reg_362)
    begin
        if (((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    dst_data_stream_3_V_blk_n_assign_proc : process(dst_data_stream_3_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, and_ln50_2_reg_358, and_ln51_reg_362)
    begin
        if (((ap_const_lv1_1 = and_ln51_reg_362) and (ap_const_lv1_1 = and_ln50_2_reg_358) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln44_fu_256_p2 <= "1" when (i_0_reg_230 = ap_const_lv10_2D0) else "0";
    icmp_ln46_fu_290_p2 <= "1" when (j_0_reg_241 = ap_const_lv11_500) else "0";
    icmp_ln50_1_fu_274_p2 <= "1" when (unsigned(i_0_reg_230) < unsigned(ap_const_lv10_26A)) else "0";
    icmp_ln50_2_fu_302_p2 <= "1" when (unsigned(j_0_reg_241) > unsigned(ap_const_lv11_DD)) else "0";
    icmp_ln50_3_fu_308_p2 <= "1" when (unsigned(j_0_reg_241) < unsigned(ap_const_lv11_422)) else "0";
    icmp_ln50_fu_268_p2 <= "1" when (unsigned(i_0_reg_230) > unsigned(ap_const_lv10_65)) else "0";

    internal_ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln44_fu_256_p2)
    begin
        if (((icmp_ln44_fu_256_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    trunc_ln44_fu_252_p1 <= i_0_reg_230(1 - 1 downto 0);
    trunc_ln46_fu_286_p1 <= j_0_reg_241(1 - 1 downto 0);
end behav;

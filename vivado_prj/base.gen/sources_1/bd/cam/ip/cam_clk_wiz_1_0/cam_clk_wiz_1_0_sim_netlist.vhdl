...
--               d:/base/base.srcs/sources_1/bd/cam/ip/cam_clk_wiz_1_0/cam_clk_wiz_1_0_sim_netlist.vhdl
-- Design      : cam_clk_wiz_1_0
...
entity cam_clk_wiz_1_0_cam_clk_wiz_1_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of cam_clk_wiz_1_0_cam_clk_wiz_1_0_clk_wiz : entity is "cam_clk_wiz_1_0_clk_wiz";
end cam_clk_wiz_1_0_cam_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of cam_clk_wiz_1_0_cam_clk_wiz_1_0_clk_wiz is
  signal clk_in1_cam_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out1_cam_clk_wiz_1_0 : STD_LOGIC;
...
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_cam_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_cam_clk_wiz_1_0,
...
entity cam_clk_wiz_1_0 is
  ...
  attribute NotValidForBitStream of cam_clk_wiz_1_0 : entity is true;
end cam_clk_wiz_1_0;

architecture STRUCTURE of cam_clk_wiz_1_0 is
begin
inst: entity work.cam_clk_wiz_1_0_cam_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked

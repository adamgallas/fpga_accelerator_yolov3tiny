...
architecture behav of hls_resize is 
    ...
    component hls_resize_AXILiteS_s_axi IS
    generic (
...
begin
    hls_resize_AXILiteS_s_axi_U : component hls_resize_AXILiteS_s_axi
    generic map (
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Mat2AXIvideo_U0_ap_idle and Downsample_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ap_ready <= AXIvideo2Mat_U0_ap_ready;
